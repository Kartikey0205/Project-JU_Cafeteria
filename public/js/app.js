...
var cartCounter = document.getElementById("cartCounter"); // cart mein update krne wala pizza aur session mein cart ko store krne k liye yhn p hm axios libraray use krenge
...
addToCart.forEach(function (btn) {
  btn.addEventListener("click", function (e) {
    ...
    var pizza = JSON.parse(btn.dataset.pizza); // server p request bhejen k function h update cart or apne cart ko store krwayenge session mein
...
order = JSON.parse(order); // console.log(order); database order for that particular id
...
var socket = io(); // y io hmko script se mil rhi h layout k
...
socket.on("orderUpdated", function (data) {
  ...
  updateStatus(updatedOrder); // message show kr rhe h
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkju_cafeteria"] = self["webpackChunkju_cafeteria"] || [];
